...
// 役割色 — トンマナ(Glass)に合わせて彩度を抑えた落ち着いた配色 (原色は使わない)
const ROLE_COLORS = {
  '営業': '#dc7a83',
  '運営': '#5b8fd6',
  'CS':   '#4aa589',
...
// ─── Demo モード用のモックスナップショット (Humano Robotics 想定) ─
function buildDemoSnapshot() {
  const businesses = ['ハードウェア', 'ソフトウェアAI', '製造', '商業']
  const requiredFTE = {
    'ハードウェア':   { '営業': 0,    '運営': 3,    'CS': 1,    '企画': 2,    '総務': 0.5,  'PR': 0   },
    'ソフトウェアAI': { '営業': 0,    '運営': 2,    'CS': 1,    '企画': 2.5,  '総務': 0.5,  'PR': 0   },
    '製造':           { '営業': 0,    '運営': 4,    'CS': 0.5,  '企画': 1,    '総務': 1,    'PR': 0   },
    '商業':           { '営業': 3,    '運営': 1,    'CS': 2,    '企画': 0.5,  '総務': 0.5,  'PR': 1.5 },
  }
  const ALLOC = (matrix) => matrix
  const members = [
    { name: '山田 太郎', role: '代表取締役', cost: 16000000, ability: 1.4, costMonthly: Array(12).fill(1200), allocMatrix: ALLOC({
      'ハードウェア':   { '営業': 0, '運営': 0,  'CS': 0,  '企画': 30, '総務': 10, 'PR': 0 },
      'ソフトウェアAI': { '営業': 0, '運営': 0,  'CS': 0,  '企画': 30, '総務': 0,  'PR': 0 },
      '製造':           { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      '商業':           { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 10, 'PR': 20 },
    }) },
    { name: '鈴木 花子', role: '副社長 兼 COO', cost: 13000000, ability: 1.3, costMonthly: Array(12).fill(1000), allocMatrix: ALLOC({
      'ハードウェア':   { '営業': 0,  '運営': 20, 'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      'ソフトウェアAI': { '営業': 0,  '運営': 20, 'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      '製造':           { '営業': 0,  '運営': 30, 'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      '商業':           { '営業': 0,  '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 30 },
    }) },
    { name: '中村 葵', role: '研究開発部 ハードウェア リーダー', cost: 11000000, ability: 1.2, costMonthly: Array(12).fill(900), allocMatrix: ALLOC({
      'ハードウェア':   { '営業': 0, '運営': 70, 'CS': 0,  '企画': 30, '総務': 0,  'PR': 0 },
      'ソフトウェアAI': { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      '製造':           { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      '商業':           { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
    }) },
    { name: '小林 龍', role: 'ハードウェア エンジニア', cost: 9000000, ability: 1.0, costMonthly: Array(12).fill(750), allocMatrix: ALLOC({
      'ハードウェア':   { '営業': 0, '運営': 80, 'CS': 0,  '企画': 20, '総務': 0,  'PR': 0 },
      'ソフトウェアAI': { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      '製造':           { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      '商業':           { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
    }) },
    { name: '加藤 さくら', role: 'AI/ML エンジニア', cost: 10500000, ability: 1.2, costMonthly: Array(12).fill(880), allocMatrix: ALLOC({
      'ハードウェア':   { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      'ソフトウェアAI': { '営業': 0, '運営': 80, 'CS': 0,  '企画': 20, '総務': 0,  'PR': 0 },
      '製造':           { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      '商業':           { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
    }) },
    { name: '田中 一郎', role: '商業部 マネージャー', cost: 10000000, ability: 1.1, costMonthly: Array(12).fill(820), allocMatrix: ALLOC({
      'ハードウェア':   { '営業': 0,  '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      'ソフトウェアAI': { '営業': 0,  '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      '製造':           { '営業': 0,  '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      '商業':           { '営業': 60, '運営': 20, 'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
    }) },
    { name: '佐藤 美咲', role: '法人営業 リーダー', cost: 8500000, ability: 1.0, costMonthly: Array(12).fill(700), allocMatrix: ALLOC({
      'ハードウェア':   { '営業': 0,  '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      'ソフトウェアAI': { '営業': 0,  '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      '製造':           { '営業': 0,  '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      '商業':           { '営業': 80, '運営': 0,  'CS': 20, '企画': 0,  '総務': 0,  'PR': 0 },
    }) },
    { name: '伊藤 健', role: 'カスタマーサクセス', cost: 7500000, ability: 0.9, costMonthly: Array(12).fill(620), allocMatrix: ALLOC({
      'ハードウェア':   { '営業': 0, '運営': 0,  'CS': 30, '企画': 0,  '総務': 0,  'PR': 0 },
      'ソフトウェアAI': { '営業': 0, '運営': 0,  'CS': 30, '企画': 0,  '総務': 0,  'PR': 0 },
      '製造':           { '営業': 0, '運営': 0,  'CS': 10, '企画': 0,  '総務': 0,  'PR': 0 },
      '商業':           { '営業': 0, '運営': 0,  'CS': 30, '企画': 0,  '総務': 0,  'PR': 0 },
    }) },
    { name: '高橋 由美', role: 'PR/マーケ マネージャー', cost: 9000000, ability: 1.1, costMonthly: Array(12).fill(750), allocMatrix: ALLOC({
      'ハードウェア':   { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      'ソフトウェアAI': { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      '製造':           { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      '商業':           { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 100 },
    }) },
    { name: '吉田 拓海', role: '製造部 マネージャー', cost: 9500000, ability: 1.1, costMonthly: Array(12).fill(800), allocMatrix: ALLOC({
      'ハードウェア':   { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      'ソフトウェアAI': { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      '製造':           { '営業': 0, '運営': 80, 'CS': 0,  '企画': 20, '総務': 0,  'PR': 0 },
      '商業':           { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
    }) },
    { name: '山本 優子', role: '製造ライン', cost: 6500000, ability: 0.9, costMonthly: Array(12).fill(540), allocMatrix: ALLOC({
      'ハードウェア':   { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      'ソフトウェアAI': { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      '製造':           { '営業': 0, '運営': 100,'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
      '商業':           { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 0,  'PR': 0 },
    }) },
    { name: '斎藤 隼人', role: '事業企画', cost: 9000000, ability: 1.1, costMonthly: Array(12).fill(750), allocMatrix: ALLOC({
      'ハードウェア':   { '営業': 0, '運営': 0,  'CS': 0,  '企画': 30, '総務': 0,  'PR': 0 },
      'ソフトウェアAI': { '営業': 0, '運営': 0,  'CS': 0,  '企画': 30, '総務': 0,  'PR': 0 },
      '製造':           { '営業': 0, '運営': 0,  'CS': 0,  '企画': 30, '総務': 0,  'PR': 0 },
      '商業':           { '営業': 0, '運営': 0,  'CS': 0,  '企画': 10, '総務': 0,  'PR': 0 },
    }) },
    { name: '松本 千夏', role: '管理部', cost: 6800000, ability: 0.9, costMonthly: Array(12).fill(560), allocMatrix: ALLOC({
      'ハードウェア':   { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 30, 'PR': 0 },
      'ソフトウェアAI': { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 30, 'PR': 0 },
      '製造':           { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 30, 'PR': 0 },
      '商業':           { '営業': 0, '運営': 0,  'CS': 0,  '企画': 0,  '総務': 10, 'PR': 0 },
    }) },
  ]
  const bizPrograms = {
    'ハードウェア':   [{ name: 'ヒューマノイド本体', amount: 800000000 }, { name: 'パーツ販売', amount: 100000000 }],
    'ソフトウェアAI': [{ name: '行動制御SDK',         amount: 150000000 }, { name: 'クラウド月額',  amount: 60000000  }],
    '製造':           [{ name: 'OEM製造受託',         amount: 200000000 }],
    '商業':           [{ name: 'リース・サブスク',    amount: 250000000 }, { name: '保守契約',     amount: 80000000  }],
  }
  const bizCosts = {
    'ハードウェア':   [{ name: '部材原価', amount: 320000000 }],
    'ソフトウェアAI': [{ name: 'クラウド費用', amount: 25000000 }],
    '製造':           [{ name: 'ライン運用費', amount: 90000000 }],
    '商業':           [{ name: '販促費', amount: 30000000 }],
  }
  const sgaItems = [{ name: '本社家賃', amount: 24000000 }, { name: '業務委託', amount: 36000000 }]
  const roleWeights = {
    'ハードウェア':   { '営業': 0,  '運営': 50, 'CS': 10, '企画': 30, '総務': 5,  'PR': 5 },
    'ソフトウェアAI': { '営業': 0,  '運営': 40, 'CS': 15, '企画': 35, '総務': 5,  'PR': 5 },
    '製造':           { '営業': 0,  '運営': 70, 'CS': 5,  '企画': 15, '総務': 10, 'PR': 0 },
    '商業':           { '営業': 50, '運営': 10, 'CS': 20, '企画': 5,  '総務': 5,  'PR': 10 },
  }
  return { members, businesses, bizShort: {}, bizPrograms, bizCosts, sgaItems, roleWeights, requiredFTE }
}
