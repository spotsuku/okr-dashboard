...
export const BRAND_GRADIENT = {
  // 濃い青 → スカイ: LP CTA / アプリの主要CTA (btnPrimary の color に渡す等)
  cta:  'linear-gradient(135deg, #1d4ed8 0%, #2563eb 45%, #0ea5e9 100%)',
  // 訴求ヒーロー帯 (白文字を載せる): LP ヒーロー / オンボーディング
  hero: 'linear-gradient(135deg, #2563eb 0%, #0ea5e9 60%, #38bdf8 100%)',
}
