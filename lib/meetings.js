...
export const MEETINGS = [
  ...
  { key: 'kickoff-frontier',     title: '週次キックオフ（フロンティア事業部）',schedule: '月曜',     icon: '🌱', color: '#ffd166' },
...
export const MEETING_URLS = {
  ...
  'kickoff-frontier':   process.env.NEXT_PUBLIC_KICKOFF_FRONTIER_URL,
...
export function getMeetingDbId(key) {
  const map = {
    ...
    'kickoff-frontier':   process.env.NOTION_KICKOFF_FRONTIER_DB_ID,
