...
export const MEETINGS = [
  ...
  // 広報週次キックオフ。経営企画部配下の単一チーム「広報」が対象 (営業定例と同型)。
  // DB (organization_meetings) 側に同 key の行があり target_filter が未設定でも、
  // WeeklyMTGPage.lookupMeeting がこの静的定義で scope/flow を補完して会議を開ける。
